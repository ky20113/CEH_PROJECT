...
- 📄 `CEH_Project_Kunal.pdf` — Full report with screenshots and command outputs  
...
```
**Results:**
- `192.168.112.130` → Ports 22 (SSH), 80 (HTTP)
- `192.168.112.130` → Port 21 (FTP)
...
In `/etc/passwd`:
```
kunal:x:1001:1001:/home/kunal:/bin/bash
```

In `/etc/shadow`:
```
kunal:$1$8nWuasXV$pk6ZABfqT9NoHv1pPX8Rj.
```
